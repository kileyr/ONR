...
namespace ONR
{
    ...
    public sealed partial class IncipientPage : Page
    {
        public FoulingDataEntry data_entry;
        public WJDataEntry wj_data_entry;

        public IncipientPage()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (e.Parameter != null && (e.Parameter is FoulingDataEntry))
            {
                ...
                IncipientTitle.Text = title;
                IF.Text = this.data_entry.incipient.IF;
            }
            else if (e.Parameter != null && (e.Parameter is WJDataEntry))
            {
                ...
                IncipientTitle.Text = title;
                IF.Text = this.wj_data_entry.data_info.incipient.IF;
            }
